    ...
    <section className="max-w-8xl mx-auto px-6 py-24 text-center space-y-16 ">
      ...
      >
        ...
        {[
          ...
          <div
            key={index}
            className="flex flex-col items-center space-y-4 rounded-lg bg-bg-light dark:bg-bg-dark p-8 shadow-sm hover:shadow-md !dark:shadow-md !dark:hover:shadow-lg transition"
          >
            {item.icon}
