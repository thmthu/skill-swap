    ...
    <div className="w-full h-[25vh] md:h-[70vh] relative">
      ...
      <div className="block md:hidden w-full h-full bg-[url('/header-background-mobile.jpg')] bg-cover bg-no-repeat bg-center bg-gradient-to-l from-black/0 via-black/20 to-black/40 overflow-hidden">
        ...
        <div
          ...
          className="w-[5rem] px-[0.75rem] py-[0.375rem] left-[1.125rem] top-[9.3125rem] absolute bg-gray-50 dark:bg-gray-800 rounded shadow-[0_0.25rem_0.25rem_0_rgba(0,0,0,0.25)] outline-[0.1rem] outline-offset-[-0.1rem] outline-red-600 inline-flex justify-center items-center gap-[0.125rem]"
        >
      ...
      <div className="hidden md:block w-[100vw] h-full bg-[url('/header-background-desktop.jpg')] bg-fit bg-center bg-no-repeat">
        {/* Content Container */}
        <div className="absolute top-6 left-4 md:top-[100px] md:left-[100px] w-[90%] max-w-[400px] md:max-w-[500px] px-4 py-5 md:px-8 md:py-10 bg-white dark:bg-gray-900 rounded-xl shadow-lg flex flex-col gap-4">
          {/* Title Section */}
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-bold font-['Poppins'] text-black dark:text-white leading-tight">
              {title}
            </h1>
          ...
          {/* Description Section */}
          <p className="text-xs md:text-sm font-normal font-['Poppins'] text-black dark:text-white leading-relaxed whitespace-pre-line">
            {description}
          </p>
