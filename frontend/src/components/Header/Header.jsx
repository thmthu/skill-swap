		...
		<div className="w-full h-[25vh] md:h-[55vh] relative">
			...
			<div className="block md:hidden w-full h-full bg-[url('/header-background-mobile.jpg')] bg-cover bg-no-repeat bg-center bg-gradient-to-l from-black/0 via-black/20 to-black/40 overflow-hidden">
				<div className="w-[13rem] left-[1.125rem] top-[2.6875rem] absolute inline-flex flex-col justify-start items-start gap-[0.25rem]">
					...
					<div className="self-stretch text-justify justify-start text-white text-xs font-normal">
						{description}
					</div>
				</div>
				<div
				...
				>
					<div className="justify-start text-red-800 text-xs font-semibold">
						{buttonText}
					</div>
				</div>
			</div>
			...
			<div className="hidden md:block w-[100vw] h-full bg-[url('/header-background-desktop.jpg')] bg-fit bg-center bg-no-repeat">
				...
				<div className="absolute top-6 left-4 md:top-[100px] md:left-[100px] w-[90%] max-w-[400px] md:max-w-[500px] px-4 py-5 md:px-8 md:py-10 bg-white dark:bg-gray-900 rounded-xl shadow-lg flex flex-col gap-4">
					...
					<div className="flex flex-col gap-2">
						<h1 className="text-2xl md:text-4xl font-bold text-black dark:text-white leading-tight">
							{title}
						</h1>
					...
					{/* Description Section */}
					<p className="text-xs md:text-sm font-normal text-black dark:text-white leading-relaxed whitespace-pre-line">
						{description}
					</p>
