    ...
    <div className="relative flex flex-col items-center">
      ...
      <div className="w-full relative flex items-center">
        ...
        <button
          ...
          className={`absolute left-[-2rem] z-10 p-2 rounded-full border transition
        ...
        <button
          ...
          className={`absolute right-[-2rem] z-10 p-2 rounded-full border transition
      ...
      <div className="flex justify-center mt-4 gap-2">
        {Array.from({ length: numPages }).map((_, i) => (
          <span
            key={i}
            className={`w-2 h-2 rounded-full transition-all duration-200 ${i === currentPage ? "bg-primary" : "bg-gray-300"}`}
          />
        ))}
      </div>
    </div>
